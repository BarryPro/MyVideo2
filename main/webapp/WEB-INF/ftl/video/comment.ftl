        ...
        $(function(){
            ...
            function article_info_delete(data,article){
                $("#article_info").append(
                        ...
                        '<div class="_articlelayout"><span class="_articlefont">'+article.adate+'</span>' +
                        '<img src='+_path+'/images/agree.png class="_my_img" title="赞" value="1"><span>'+article.agree+'</span>' +
                        '<img src='+_path+'/images/disagree.png class="_my_img" title="踩" value="2"><span>'+article.disagree+'</span>' +
                        '<img src='+_path+'/images/reply.png class="_my_img" alt='+article.aid+' value='+article.user.username+' title="回贴" >' +
                        '<img src='+_path+'/images/delete.png class="_my_img" value='+article.user.username+' title="删帖"></div></td>' +
                        '</table>'+
                        '<label style="display:none" id="cur_page_hidden" title='+data.cur_page+'/>'+
                        '<label style="display:none" id="max_page_hidden" title='+data.page_total+'/>'
                );
