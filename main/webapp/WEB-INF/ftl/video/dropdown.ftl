<link href="${mypath}/css/my_menu.css" rel='stylesheet' type='text/css' media="all"/>
<ul class="menu">
    <li><img src="${mypath}/images/login.png" alt="请登录" class="user_avatar my_img" />
        <b class="my_font">游客</b></a>
        <ul class="submenu">
